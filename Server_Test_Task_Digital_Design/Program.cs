...
namespace Server_Test_Task_Digital_Design
{
                ...
                while (true)
                {
                    ...
                    switch (operType)
                    {
                        ...
                        case 3:
                            ...
                            string nameFile = dataBase.model.Files.Where(x=>x.file_id==id).Single().file_name;
